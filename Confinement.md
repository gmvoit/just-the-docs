...
{: .note}
An **ExpCGM** model atmosphere inevitably becomes unrealistic beyond $r \sim 3 R_{\rm halo}$ because the dynamical time there starts to exceed the universe's age. The force-balance assumption at the foundation of **ExpCGM** atmosphere models therefore becomes unphysical. The factor of 3 comes from the spherical collapse model, in which mass shells near $r \sim 3 R_{\rm halo}$ have reached their maximum radii and are starting to fall back toward the halo. More precisely, Kepler's Third Law gives $R_{\rm ta}(t) = 2^{2/3} R_{\rm ta}(t/2) \approx 2^{5/3} R_{\rm halo}(t)$ for the turnaround radius $R_{\rm ta}$ in a spherical collapse model without dark energy. Atmospheric gas pushed beyond $r \sim 3 R_{\rm halo}$ is therefore entering a region where cosmological expansion dominates the dynamics and needs to be modeled in a context that accounts for the atmosphere's expansion speed.   

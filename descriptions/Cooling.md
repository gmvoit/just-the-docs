...
{: .important}
Cooling gas can be flowing into a halo's central galaxy even if total heat input into the galaxy's atmosphere exceeds total radiative cooling. What matters more is how *local* heating compares to *local* cooling in the vicinity of $r_{\rm gal}$. If cooling locally exceeds heating in at least some atmospheric regions near $r_{\rm gal}$, then a global excess of heating over cooling does not immediately choke off the galaxy's gas supply. In the **ExpCGM** framework excess heating instead limits the galaxy's gas supply by expanding the galaxy's atmosphere, resulting in a gradual decline in $\dot{M}\_{\rm cool}(r_{\rm gal})$ as expansion lowers the atmosphere's overall density.
